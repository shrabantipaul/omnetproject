...
#ifndef __MYPROJECT_PKT_FIFO_SOURCE_H_
#define __MYPROJECT_PKT_FIFO_SOURCE_H_
...
private:
    ...
    int dstId;
    int flitSize_B;
    simtime_t statStartTime; // in second
    bool isSynchronous;       // if true will send packets on clock with frequency of out link
